...
Shader "Hidden/_lil/lilToonRefraction"
{
    Properties
    {
        //----------------------------------------------------------------------------------------------------------------------
        ...
        [Enum(RenderingMode)] _Mode ("Rendering Mode", Int) = 5
        ...
        [NoScaleOffset] _ReflectionBlendMask ("Blend Mask", 2D) = "white" {}
        ...
        _EmissionBlendMask ("Mask Texture", 2D) = "white" {}
        ...
        _Emission2ndBlendMask ("Mask Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        // テクスチャ名を指定しないとオブジェクトごとにグラブされて負荷が高くなる
